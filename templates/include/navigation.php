<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="#"><img src="templates/images/logo.png" alt="logo" class="logo"></a>
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="#"> GraveurX</a>
        </div>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="graveur.php"> Graveuse </a>
      </li>
      <li class="nav-item">
